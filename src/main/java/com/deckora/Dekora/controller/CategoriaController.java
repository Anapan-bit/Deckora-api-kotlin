...
import com.deckora.Dekora.assemblers.CategoriaModelAssembler;
import com.deckora.Dekora.model.Categoria;
import com.deckora.Dekora.service.CategoriaService;
...
public class CategoriaController {
    ...
    public ResponseEntity<EntityModel<Categoria>> createCategoria(@Parameter(description = "Detalles del categoria", required = true)@RequestBody Categoria categoria){
        ...
        return ResponseEntity
                .created(linkTo(methodOn(CategoriaController.class).getCategoriaById(Long.valueOf(newCategoria.getId()))).toUri())
